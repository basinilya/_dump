...
--%><%--
			--%><fieldset>
					...
					<label>
						<input type="radio" name="${prefix}null" value="true" <c:if test="${!nullable}">disabled="disabled"</c:if> >
						Null
					</label>
					<label>
						<input type="radio" name="${prefix}null" value="false" checked="checked" >
						Not null:
					</label>
					</div>
					<div>
					...
					<input type="text" disabled="disabled" name="${prefix}oldRestrict" value="${param.restrict}"/>
					<br/>
					<label>
						Restrict:
						<input type="text" name="${prefix}restrict" />
					</label>
					</div>
